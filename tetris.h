...
void move_drop(t_tetris *tetris, t_tetrimino *current, t_tetrimino *temp_for_judge, const t_tetrimino *type);
void move_rotate(t_tetris *tetris, t_tetrimino *current, t_tetrimino *temp_for_judge);
